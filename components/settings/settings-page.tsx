            ...
            <CardContent className="w-full text-left">
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant="destructive" className="w-full py-3 text-base font-semibold rounded-xl">
                    Delete Account
                  </Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      <br />
                      <br />
                      • All job applications and their history
                      <br />
                      • Email integrations and settings
                      <br />
                      • Platform integrations (LinkedIn, etc.)
                      <br />
                      • Profile information and preferences
                      <br />
                      • All associated emails and notifications
                      <br />
                      <br />
